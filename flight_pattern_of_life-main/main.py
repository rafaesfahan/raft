...
def train_func():
    ...
    #model_enum = ModelEnum.SimpleLSTM
    ...
    # individual_flights_dir = '/home/trumoo/Downloads/slock/flights/cleaned/cleaned/cleaned/fdir/'
